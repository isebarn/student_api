...
flight_info_reference = api.model(
    "flight_info_reference", models.FlightInfo.reference()
)
...
host_family_reference = api.model(
    "host_family_reference", models.HostFamily.reference()
)
...
class AirportController(Resource):
    ...
    @api.marshal_with(api.models.get("airport"))
    def post(self):
...
class StudentPersonalDataController(Resource):
    ...
    @api.marshal_with(api.models.get("student_personal_data_reference"), skip_none=True)
    def post(self):
        return models.StudentPersonalData(**request.get_json()).to_json()

    @api.marshal_with(api.models.get("student_personal_data_reference"), skip_none=True)
    def put(self):
        return models.StudentPersonalData.update(**request.get_json()).to_json()
